...
-- nvim-tree
keymap.set("n", "<leader>e", ":Neotree toggle<CR>", { silent = true }) -- toggle file explorer
...
-- keymap.set('v', '<Leader>s',  function() silicon.visualise_api() end )
-- -- Generate image of a whole buffer, with lines in a visual selection highlighted
-- keymap.set('v', '<Leader>bs', function() silicon.visualise_api({to_clip = true, show_buf = true}) end )
-- -- Generate visible portion of a buffer
-- keymap.set('n', '<Leader>s',  function() silicon.visualise_api({to_clip = true, visible = true}) end )
-- -- Generate current buffer line in normal mode
-- keymap.set('n', '<Leader>s',  function() silicon.visualise_api({to_clip = true}) end )
--
vim.cmd([[
...
nnoremap <silent><A-p> :BufferLinePickClose<CR>
nnoremap <silent><Leader>x[ :BufferLineCloseLeft<CR>
nnoremap <silent><Leader>x] :BufferLineCloseRight<CR>
]])
-- dap debug
